...
pointhigh=list(filter(lambda t:t["points"]==reduce(lambda p1,p2:p1 if p1>p2 else p2,list(map(lambda t:t["points"],isl_2019))),isl_2019))
print(pointhigh)
# pointhigh1=reduce(lambda p1,p2:p1 if p1>p2 else p2,list(map(lambda t:t["points"],isl_2019)))
# print(pointhigh1)